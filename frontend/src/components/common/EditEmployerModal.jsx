        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Edit Employer">
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex justify-end">
                    <button type="button" onClick={onClose} className="mr-2 px-4 py-2 text-sm font-medium text-gray-700  bg-white  border border-gray-300  rounded-md hover:bg-gray-50 ">
                        Cancel
                    </button>
