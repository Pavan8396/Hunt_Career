  ...
  return (
    ...
    >
      <div className="max-w-md w-full bg-gradient-to-br from-white to-gray-50   p-8 rounded-xl shadow-2xl backdrop-blur-sm">
        <h2 className="text-3xl font-extrabold text-center mb-6 text-gray-800 ">Employer Signup</h2>
        ...
        <div className="mt-6 border-t border-gray-200  pt-4">
          <p className="text-center text-sm text-gray-600 ">
            ...
            <Link to="/employer/login" className="text-blue-600  relative inline-block group">
              Log in
